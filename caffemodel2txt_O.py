...
# 预先训练好的caffe模型
PRETRAIN_FILE = '48net.caffemodel'
# 保存参数的文件
params_txt = 'Onet_v4.txt'
...
for param_name in net.params.keys():
	...
	print('shape',shape)
	    ...
	    weight.shape = (-1,1)
	    if (len(weight) == 294912):

		    C=weight.reshape((256,128,3,3))
		    print('73728 w shape',C.shape)
		    for amountCount in range (0, 256):
		            for depthCount in range(128):
